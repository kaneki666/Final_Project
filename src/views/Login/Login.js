...
import { IoIosApps, IoIosLock, IoIosMan } from "react-icons/io";
...
const items = [
  ...
  <Input
    size="small"
    prefix={<IoIosMan style={{ color: "rgba(0,0,0,.25)" }} />}
    placeholder="Username"
  />,
  <Input
    size="small"
    prefix={<IoIosLock style={{ color: "rgba(0,0,0,.25)" }} />}
    type="password"
...
export default class App extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      >
        <IoIosApps className="sidebar-toggle" onClick={this.toggle} />
